...
if($userdata['user_ec_id'] != -1) {
$template->assign_block_vars("switch_ec",array("L_ECTRANS"=>"Transfer Cash","U_ECTRANS"=>"./cash.php?mode=transcls"));
}
//------------------------------------------------------------------------
// Prillian - Begin Code Addition
//
...
$template->assign_vars(array(
	...
	'L_STORE' => $lang['Stores_link'],
  	'U_ITEMS' => append_sid('store.'.$phpEx.'?mode=user_items'),
  	'L_ITEMS' => $lang['Stores_items_link'],

        'L_LIST' => 'All Items',
        'U_LIST' => append_sid('shop.'. $phpEx.'?action=allinventory'),
