...
if(! isset($_REQUEST['Submit'] ) )
{
	...
	<table width="100%" cellpadding="4" cellspacing="1" border="0">
		...
		<tr>
			...
			<td width="25%" class="row2"><input type="text" name="odds_items" size="50" value="'.$cur_odds_items.'"></td>
		</tr>
		<tr>
			<td width="75%" class="row1">'.$lang['admin_itemfinder_items'].'</td>
			<td width="25%" class="row2"><input type="text" name="items" size="50" value="'.$cur_items.'"></td>
		</tr>
		<tr>
			<td width="75%" class="row1">'.$lang['admin_itemfinder_oddsMoney'].'</td>
			<td width="25%" class="row2"><input type="text" name="odds_money" size="50" value="'.$cur_odds_money.'"></td>
		</tr>
		<tr>
			<td width="75%" class="row1">'.$lang['admin_itemfinder_money_min'].'</td>
			<td width="25%" class="row2"><input type="text" name="money_min" size="50" value="'.$cur_money_min.'"></td>
		</tr>
		<tr>
			<td width="75%" class="row1">'.$lang['admin_itemfinder_money_max'].'</td>
			<td width="25%" class="row2"><input type="text" name="money_max" size="50" value="'.$cur_money_max.'"></td>
		</tr>
	  	<tr>
