...
$sql[] = "INSERT INTO `" . $table_prefix . "shops` (`shopname`, `shoptype`) VALUES('Synthesize Shop', 'admin_only')"; # This MUST be added and not renamed!
$sql[] = "INSERT INTO `" . $table_prefix . "shops` (`shopname`, `shoptype`, `url`) VALUES('Synthesizing', 'Synthesizing', 'shop_synth.php')"; # This may be renamed.
