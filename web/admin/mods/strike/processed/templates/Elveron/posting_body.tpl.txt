			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
				  <td><span class="genmed"> &nbsp;{L_FONT_COLOR}: 
					...
					</select>&nbsp;{L_ALIGN_ALIGNMENT}:<select name="addbbcodefontalign" onChange="bbfontstyle('[align=' + this.form.addbbcodefontalign.options[this.form.addbbcodefontalign.selectedIndex].value + ']', '[/align]')" onMouseOver="helpline('al')">
