...
if ( !$mode )
{
	...
	while ( $row = $db->sql_fetchrow($result) )
	{
		...
		'TEMPL_NAME' => $row['selection_name'],
		'EDIT' => '<a href="' . $edit_url . '"><img src="' . $phpbb_root_path . $images['icon_edit'] . '" alt="' . $lang['bookie_edit_template'] . '" title="' . $lang['bookie_edit_template'] . '" border="0" /></a>',
		...
		'DROP_IMAGE' => '<a href="' . $drop_url . '"><img src="' . $phpbb_root_path . $images['icon_bookie_drop_meeting'] . '" alt="' . $lang['icon_bookie_drop_template'] . '" title="' . $lang['icon_bookie_drop_template'] . '" border="0" /></a>',
		'ANCHOR' => $this_templ,
			));
...
'IMG_NEW_TEMPL' => '<a href="' . $add_selection_templ_url . '"><img src="' . $phpbb_root_path . $images['icon_bookie_add_selection_template'] . '" alt="' . $lang['icon_bookie_add_selection_template'] . '" title="' . $lang['icon_bookie_add_selection_template'] . '" border="0" /></a>',
