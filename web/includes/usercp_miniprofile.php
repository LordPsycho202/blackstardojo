...
$cashu = new cash_user($HTTP_GET_VARS[POST_USERS_URL]);
$template->assign_vars(array(
	...
	'CASH' => $cashu->amount(2)." Yen, ".$cashu->amount(4). " Gerbils, ".$cashu->amount(3)." Cornelius Lives, ".$cashu->amount(5)." Souls",
	'MODIFY_CASH' => '[ <a href="http://www.blackstardojo.org/cash.php?mode=modedit&ref=viewprofile&u='.$HTTP_GET_VARS[POST_USERS_URL].'">Modify User\'s Cash</a> ]',
