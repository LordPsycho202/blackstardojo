...
function submit_item_post( &$post_data, &$message, &$meta, &$forum_id, &$topic_id, &$post_id, &$topic_type, &$bbcode_on, &$html_on, &$smilies_on, &$attach_sig, &$bbcode_uid, $post_subject, $post_message)
{
	...
	$edited_sql = '';
	//echo "Inserting into post table";
	...
	//echo "Inserting into text table, ".$post_message.", ".$post_id."</p>";
