...
// This file modified by A_Jelly_Doughnut of the OCbb Development Team
// Removed some features deemed unneeded for OCbb, made to conform to OCbb
// coding standards
// OCbb changes began 11-12-05
// $Id: functions_freecap.php,v 1.1 2005/11/15 01:50:26 jelly_doughnut Exp $
...
$font_locations = array($phpbb_root_path . "includes/freecap/.ht_freecap_font1.gdf", $phpbb_root_path . "includes/freecap/.ht_freecap_font2.gdf", $phpbb_root_path . "includes/freecap/.ht_freecap_font3.gdf", $phpbb_root_path . "includes/freecap/.ht_freecap_font4.gdf", $phpbb_root_path . "includes/freecap/.ht_freecap_font5.gdf");
...
$bg_images = array($phpbb_root_path . "includes/freecap/.ht_freecap_im1.jpg", $phpbb_root_path . "includes/freecap/.ht_freecap_im2.jpg", $phpbb_root_path . "includes/freecap/.ht_freecap_im3.jpg", $phpbb_root_path . "includes/freecap/.ht_freecap_im4.jpg", $phpbb_root_path . "includes/freecap/.ht_freecap_im5.jpg");
...
$width = (6 * (array_sum($font_widths) / sizeof($font_widths)) + 75);
$height = 90;
...
function myImageBlur($im)
{
	...
	$distance = 1;
	// Feel free to uncomment this if you want more blurry images.  Most (8/10) of them turn out OK
...
// Get word...this was changed for OCbb because $code is generated in ucp_register.php
$word = strtolower($code);
$word = preg_replace('#(\d)#e', 'chr($1 + 96)', $word);
...
if ($bg_type != 0)
{
	...
	if ($bg_type == 1)
	{
		...
		{
			ImageSetThickness($temp_bg,mt_rand(2,6));
...
// so that's cool.
$tag_str = "OCbb CAPTCHA powered by freeCap v1.4";
// for debug:
//$tag_str = "[".$word."]";
