...
<form action="{switch_edit_item.UPDATE_URL}" method="post">
	<tr> 
	  ...
	  <td class="row3" valign="top"><textarea name="item_notes" cols="35" rows="2">{switch_edit_item.ITEM_NOTES}</textarea></td>
...
<!-- BEGIN switch_are_a_items -->
	...
	<tr>
	  ...
	  <td class="row1"><textarea name="item_notes" cols="35" rows="5"></textarea></td>
	</tr>
	<tr>
