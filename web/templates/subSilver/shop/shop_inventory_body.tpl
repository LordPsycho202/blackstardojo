  ...
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
	  ...
	  <td class="row3"><span class="gensmall"><b>{L_USABLE}</b></span></td>
...
<!-- BEGIN list_wrapped -->
	<tr>
	  <td class="{list_wrapped.ROW_NUM}"><span class="gensmall"><img src="shop/images/wrapped/{list_wrapped.WRAPPED}.{list_wrapped.FILE_EXT}" title="{list_wrapped.WRAPPED}" alt="{list_wrapped.WRAPPED}" width="40" height="40"></span></td>
	  ...
	  <td class="{list_wrapped.ROW_NUM}"><span class="gensmall"></span></td>
	  {list_wrapped.AMOUNT}
	</tr>
<!-- END list_wrapped -->
<!-- BEGIN list_items -->
	<tr>
	  <td class="row2"><span class="gensmall"><img src="shop/images/{list_items.ITEM_NAME}.{list_items.IMG_EXT}" title="{list_items.ITEM_NAME}" alt="{list_items.ITEM_NAME}" width="40" height="40"></span></td>
	  ...
	  <td class="row2" align="center" valign="center"><span class="gensmall">{list_items.ITEM_USABLE}</span></td>
	  {list_items.AMOUNT}
	</tr>
<!-- END list_items -->
  </table>
...
<br />
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
	  <td class="row1" width="50%"><a href="{U_INVENTORY}" class="gensmall">{L_INVENTORY}</a> <span class="gensmall">- Current Size: {U_INV_SIZE}/{U_MAX_INV}</span></td>
