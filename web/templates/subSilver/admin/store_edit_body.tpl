...
<table width="100%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
  ...
  <tr>
    ...
    <td class="row2"><input type="text" size="25" name="item_image" value="{ITEM_IMAGE}"></td>
  </tr>
  <tr>
    <td class="row1">{L_ITEM_SPECIAL}</td>
    <td class="row2"><input type="radio" name="special" value="0" {SPECIAL_NO}> {L_NO} <input type="radio" name="special" value="1" {SPECIAL_YES}> {L_YES}</td>
  </tr>
  <!-- END switch_item -->
  <tr>
