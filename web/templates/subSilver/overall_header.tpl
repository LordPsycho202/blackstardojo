...
<head>
<link rel="shortcut icon" href="favicon_subsilver.gif" >
	...
	<tr> 
		<td class="bodyline">
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				<tr> 
					<td width="20%">
						<a href="{U_INDEX}"><img src="templates/subSilver/images/logo_phpBB.jpg" border="0" alt="{L_INDEX}" vspace="1" /></a>
					</td>
					<td align="center" width="80%" valign="middle">
							...
							<tr> 
								<td align="center" valign="top" nowrap="nowrap">
									<span class="mainmenu">
										...
										&nbsp;<a href="{U_WIO}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_groups.gif" width="12" height="13" border="0" alt="{L_WIO}" hspace="3" />{L_WIO}</a>&nbsp;
										&nbsp;<a href="{U_FAQ}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_faq.gif" width="12" height="13" border="0" alt="{L_FAQ}" hspace="3" />{L_FAQ}</a>&nbsp; &nbsp;<a href="{U_USER_SHOPS}" class="mainmenu"><img src="templates/subSilver/images/icon_user_shop.gif" width="12" height="13" border="0" alt="{L_USER_SHOPS}" hspace="3" />{L_USER_SHOPS}</a>&nbsp; &nbsp;<a href="{U_AUCTIONS}" class="mainmenu"><img src="templates/subSilver/images/icon_auctions.gif" width="12" height="13" border="0" alt="{L_AUCTIONS}" hspace="3" />{L_AUCTIONS}</a>&nbsp; &nbsp;<a href="{U_SHOP}" class="mainmenu"><img src="templates/subSilver/images/icon_shop.gif" width="12" height="13" border="0" alt="{L_SHOP}" hspace="3" />{L_SHOP}</a>&nbsp; &nbsp;<a href="{U_shop_list}" class="mainmenu"><img src="templates/subSilver/images/icon_shop.gif" width="12" height="13" border="0" alt="{L_shop_list}" hspace="3" />{L_shop_list}</a>&nbsp; 
										&nbsp;<a href="{U_RANKS}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_groups.gif" width="12" height="13" border="0" alt="{L_RANKS}" hspace="3" />{L_RANKS}</a>&nbsp;
										&nbsp;<a href="{U_STAFF}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_groups.gif" width="12" height="13" border="0" alt="{L_STAFF}" hspace="3" />{L_STAFF}</tr><tr></a>&nbsp;<br/>
										...
										&nbsp;<a href="{U_LOTTERY}" class="mainmenu"><img src="images/yen.png" width="12" height="13" border="0" alt="{L_LOTTERY}" hspace="3" />{L_LOTTERY}</a>&nbsp;
										&nbsp;<a href="{U_EXCHANGE}" class="mainmenu"><img src="images/yen.png" width="12" height="13" border="0" alt="{L_EXCHANGE}" hspace="3" />{L_EXCHANGE}</a>&nbsp;<br/>
										&nbsp;<a href="{U_WIKI}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_faq.gif" width="12" height="13" border="0" alt="{L_WIKI}" hspace="3" />{L_WIKI}</a>&nbsp;
										...
										&nbsp;<a href="{U_JRCHAT}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_profile.gif" width="12" height="13" border="0" alt="{L_JRCHAT}" hspace="3" />{L_JRCHAT}</a>&nbsp;<br/>
										&nbsp;<a href="{U_JRCHATRP}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_profile.gif" width="12" height="13" border="0" alt="{L_JRCHATRP}" hspace="3" />{L_JRCHATRP}</a>&nbsp;
										...
										&nbsp;<a href="{U_LOGIN_LOGOUT}" class="mainmenu"><img src="templates/subSilver/images/icon_mini_login.gif" width="12" height="13" border="0" alt="{L_LOGIN_LOGOUT}" hspace="3" />{L_LOGIN_LOGOUT}</a>&nbsp;
                                                                                &nbsp;*&nbsp;<a href="/affiliates.php" class="mainmenu">Affiliates</a>
										<!-- BEGIN switch_user_logged_out -->
						...
						<!-- BEGIN switch_user_logged_in -->
							<tr>
								<td height="25" align="center" valign="top" nowrap="nowrap"><span class="mainmenu">&nbsp
<!-- Prillian - Begin Code Additions -->
...
<!-- Prillian - End Code Additions -->
				...
				<tr>						
						...
						<marquee scrollamount="3" direction="left" loop="true" onmouseover="this.stop()" onmouseout="this.start()">
							<a href="shop.php" class="mainmenu">
								| <b>CURRENT MAX ITEM RARITY INDEX:</b> {MAX_ITEM_RARITY_I} |
							</a>
							<a href="vault.php" class="mainmenu">
								| <b>BLACKSTAR MARKET INDEX:</b> {STOCK_INDEX} ({STOCK_INDEX_DIFF}) |
							</a>
							<!-- BEGIN stock_tick -->
								<a href="vault.php" class="mainmenu">
									| <b>{stock_tick.STOCK_NAME}:</b> {stock_tick.STOCK_VALUE} ({stock_tick.STOCK_DIFF}) | 
								</a>
							<!-- END stock_tick -->
