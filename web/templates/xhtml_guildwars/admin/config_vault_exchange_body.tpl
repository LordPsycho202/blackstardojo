...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline" width="80%">
	<tr>
		<td class="catHead" colspan="8" align="center">{L_STOCK_EXCHANGE_ACTIONS}</td>
	</tr>
	<tr>
		<th class="thCornerL">{L_STOCK_NAME}</th>
		<th class="thTop">{L_STOCK_DESC}</th>
		<th class="thTop">{L_STOCK_AMOUNT}</th>
		<th class="thTop">{L_STOCK_OUT}</th>
		<th class="thTop">{L_STOCK_CAP}</th>
	...
	<tr>
		...
		<td class="{exchange.ROW_CLASS}" align="center">{exchange.STOCK_OUT}</td>
		<td class="{exchange.ROW_CLASS}" align="center">{exchange.STOCK_CAP}</td>
	...
	<!-- END exchange -->
	<tr>
		<td class="catBottom" colspan="8" align="center">{S_HIDDEN_FIELDS}<input type="submit" name="add" value="{L_STOCK_ADD}" class="mainoption" /></td>
	</tr>
</table>
