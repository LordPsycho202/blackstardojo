...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
		...
		<td class="{processbet.ROW_CLASS}" align="center" valign="middle">
			<table>
				<tr>
					<td><input type="radio" name="{processbet.WINNER}" value="yes" />
					<span class="gen">{L_YES}
					</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{processbet.WINNER}" value="no" />
					<span class="gen">{L_NO}</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{processbet.WINNER}" value="ref" />
	...
	<!-- BEGIN normal_need -->
	<tr>
		<td class="catBottom" colspan="5" align="center"><span class="gen"><input type="submit" name="process_na" value="{PROCESS_GO}" class="mainoption" /></span><input type="hidden" name="betid_arr" value="{NA_BETID_ARR}" /></td>
	</tr>
	<!-- END normal_need -->
	</form>
</table>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
		...
		<td class="{process_ew_bet.ROW_CLASS}" align="center" valign="middle">
			<table>
				<tr>
					<td><input type="radio" name="{process_ew_bet.WINNER}" value="eww" />
					<span class="gen">{L_EWW}</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{process_ew_bet.WINNER}" value="ewp" />
					<span class="gen">{L_EWP}</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{process_ew_bet.WINNER}" value="no" />
					<span class="gen">{L_NO}</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{process_ew_bet.WINNER}" value="ref" />
					<span class="gen">{L_REF}</span></td>
				</tr>
			</table>
		</td>
	...
	<!-- BEGIN ew_need -->
	<tr>
		<td class="catBottom" colspan="5" align="center"><span class="gen"><input type="submit" name="process_na" value="{PROCESS_GO}" class="mainoption" /></span><input type="hidden" name="betid_arr" value="{AE_BETID_ARR}" /></td>
	</tr>
	<!-- END ew_need -->
	</form>
</table>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
		...
		<td class="{processbet_user_norm.ROW_CLASS}" align="center" valign="middle">
			<table>
				<tr>
					<td><input type="radio" name="{processbet_user_norm.WINNER}" value="yes" />
					<span class="gen">{L_YES}
					</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{processbet_user_norm.WINNER}" value="no" />
					<span class="gen">{L_NO}</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{processbet_user_norm.WINNER}" value="ref" />
					<span class="gen">{L_REF}</span></td>
				</tr>
			</table>
		</td>
	...
	<!-- BEGIN user_normal_need -->
	<tr>
		<td class="catBottom" colspan="5" align="center"><span class="gen"><input type="submit" name="process_na" value="{PROCESS_GO}" class="mainoption" /></span><input type="hidden" name="betid_arr" value="{NU_BETID_ARR}" /></td>
	</tr>
	</form>
</table>
<!-- END user_normal_need -->
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
		...
		<td class="{processbet_user_ew.ROW_CLASS}" align="center" valign="middle">
			<table>
				<tr>
					<td><input type="radio" name="{processbet_user_ew.WINNER}" value="eww" />
					<span class="gen">{L_EWW}</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{processbet_user_ew.WINNER}" value="ewp" />
					<span class="gen">{L_EWP}</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{processbet_user_ew.WINNER}" value="no" />
					<span class="gen">{L_NO}</span></td>
				</tr>
				<tr>
					<td><input type="radio" name="{processbet_user_ew.WINNER}" value="ref" />
					<span class="gen">{L_REF}</span></td>
				</tr>
			</table>
		</td>
	...
	<!-- BEGIN user_ew_need -->
	<tr>
		<td class="catBottom" colspan="5" align="center"><span class="gen"><input type="submit" name="process_na" value="{PROCESS_GO}" class="mainoption" /></span><input type="hidden" name="betid_arr" value="{UE_BETID_ARR}" /></td>
	</tr>
	</form>
</table>
<!-- END user_ew_need -->
