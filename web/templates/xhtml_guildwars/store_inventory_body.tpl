...
<table width="100%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
  ...
  <tr>
    ...
    <td class="row1"><span class="forumlink"><a href="javascript:itemwindow({item_row.ID})" class="forumlink">{item_row.ITEM}</a></span><span class="gen"><br />{item_row.DESCRIPTION} {item_row.SPECIAL}</span></td>
