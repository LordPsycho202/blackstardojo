...
<!-- END switch_pms -->
	<tr>
		<td class="row1" valign="middle"><span class="genmed"><a href="{U_NEW_POST}" target="phpbbmain">{L_NEW_POSTS}</a></span></td>
		<td class="row2" align="center" valign="middle"><span class="gen">{NEW_POSTS}</span></td>
	</tr>
	<tr>
		<td class="row1" valign="middle"><span class="genmed"><a href="{U_USERS_ONLINE}" target="phpbbmain">{L_USERS_ONLINE}</a></span></td>
		<td class="row2" align="center" valign="middle"><span class="gen">{USERS_ONLINE}</span></td>
	</tr>
	<tr>
		<td class="row1" valign="middle"><span class="genmed"><a href="{U_USERS_ONLINE}" target="phpbbmain">{L_HIDDEN_USERS_ONLINE}</a></span></td>
		<td class="row2" align="center" valign="middle"><span class="gen">{HIDDEN_USERS_ONLINE}</span></td>
	</tr>
	<tr>
		<td class="row1" valign="middle"><span class="genmed"><a href="{U_USERS_ONLINE}" target="phpbbmain">{L_GUESTS_ONLINE}</a></span></td>
