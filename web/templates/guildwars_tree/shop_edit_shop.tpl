...
<form action="{S_CONFIG_ACTION}" method="post">
  ...
  <input type="hidden" name="shopid" value="{SHOP_ID}" />
	...
	<tr>
	  ...
	  <td class="row2"><input type="text" class="post" name="ammo" size="32" maxlength="16"></td>
	</tr>
	  <td class="row2"><span class="gensmall">{L_PASS}</span> %U will be substituted by user's name, %T by supplied target text</td>
	  <td class="row2"><input type="text" class="post" name="pass" size="32" maxlength="128"></td>
	</tr>
	</tr>
	  <td class="row2"><span class="gensmall">{L_FAIL}</span> %U will be substituted by user's name, %T by supplied target text</td>
	  <td class="row2"><input type="text" class="post" name="fail" size="32" maxlength="128"></td>
	</tr>
	</tr>
	  <td class="row2"><span class="gensmall">{L_BREAK}</span></td>
	  <td class="row2"><input type="text" class="post" name="btext" size="32" maxlength="128"></td>
	</tr>
	</tr>
	  <td class="row2"><span class="gensmall">{L_PROB}</span></td>
	  <td class="row2"><input type="text" class="post" name="prob" size="32" maxlength="3"></td>
	</tr>
	</tr>
	  <td class="row2"><span class="gensmall">{L_BPROB}</span></td>
	  <td class="row2"><input type="text" class="post" name="break" size="32" maxlength="3"></td>
	</tr>
	<tr>
