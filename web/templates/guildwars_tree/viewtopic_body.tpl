...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
	...
	<!-- BEGIN postrow -->
	<tr> 
		<td width="150" align="left" valign="top" class="{postrow.ROW_CLASS}"><span class="name"><a name="{postrow.U_POST_ID}"></a><b>{postrow.MINIPROFILE}</b></span><br /><span class="postdetails">{postrow.USER_RANK_01}{postrow.USER_RANK_01_IMG}{postrow.USER_RANK_02}{postrow.USER_RANK_02_IMG}{postrow.USER_RANK_03}{postrow.USER_RANK_03_IMG}{postrow.USER_RANK_04}{postrow.USER_RANK_04_IMG}{postrow.USER_RANK_05}{postrow.USER_RANK_05_IMG}<br />{postrow.POSTER_AVATAR}<br /><br /><!--{postrow.POSTER_JOINED}<br />-->{postrow.POSTER_POSTS}<br /><!--{postrow.POSTER_FROM}<br />{postrow.POSTER_VAULT}<br />{postrow.CASH}<br />{postrow.USER_ITEMS}<br />{postrow.CASH_OPTIONS}<br />-->{postrow.POSTER_Ri}<br />{postrow.POSTER_MEDAL_COUNT}<br />
		<!-- BEGIN medal -->
	...
	<tr> 
		<td class="spaceRow" colspan="2" height="1"><img src="templates/guildwars_tree/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<tr>
		<th class="thLeft" width="150" height="26" nowrap="nowrap">{L_AUTHOR}</th>
		<th class="thRight" nowrap="nowrap">{L_MESSAGE}</th>
