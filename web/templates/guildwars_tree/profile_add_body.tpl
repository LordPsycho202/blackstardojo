...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  <td class="row1"><span class="gen">Forum-specific images:</span></td>
	  <td class="row2"> 
		<input type="radio" name="pfimgs" value="1" {PFIMGS_YES} />
		<span class="gen">{L_YES}</span>&nbsp;&nbsp; 
		<input type="radio" name="pfimgs" value="0" {PFIMGS_NO} />
		<span class="gen">{L_NO}</span></td>
	</tr>
	<tr> 
	...
	<tr>
	<tr align="left">
	<td class="row1"><span class="gen">{L_AS_USERNAME}</span></td>
	<td class="row2"><input type="text" class="post" style="width: 150px"  name="linkname" size="20" maxlength="255" value="{LINKNAME}" /></td>
	</tr><tr>
	<td class="row1"><span class="gen">{L_AS_PASSWORD}</span></td>
	<td class="row2"><input type="password" class="post" style="width: 150px"  name="linkpass" size="20" maxlength="255" value="{LINKPASS}" /></td>
	</tr><tr>
	<td class="row1"><span class="gen">{L_AS_PID}</span></td>
	<td class="row2"><input type="password" class="post" style="width: 150px"  name="linkpid" size="20" maxlength="255" value="{PID}" /></td>
	</tr><tr>
	<td class="row1"><span class="gen">{L_AS_PRIMARY}</span></td>
	<td class="row2"><input type="checkbox" name="primary" value="1" {PRIMARY}></td>
	</tr>
