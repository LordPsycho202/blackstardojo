...
<table width="100%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
  ...
  <tr>
    ...
    <td class="row2"><input class="post" type="text" name="amount" value="{AMOUNT}" size="30"></td>
  </tr>
  <tr>
    <td class="row1"><span class="gen">{L_PRICE}</span></td>
    <td class="row2"><input class="post" type="text" name="price" value="{PRICE}" size="30"></td>
  </tr>
  <tr>
    <td class="row1"><span class="gen">{L_RESTOCK_TIME}</span></td>
    <td class="row2"><input class="post" type="text" name="restock_time" value="{RESTOCK_TIME}" size="30"></td>
  </tr>
  <tr>
    <td class="row1"><span class="gen">{L_RESTOCK_AMOUNT}</span></td>
    <td class="row2"><input class="post" type="text" name="restock_amount" value="{RESTOCK_AMOUNT}" size="30"></td>
  </tr>
  <tr>
