...
<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR>
		<TD>
			<a href="{U_INDEX}"><IMG SRC="templates/guildwars_tree/images/header_logo_01.gif" WIDTH=238 HEIGHT=194 ALT="{L_INDEX}" border="0"></TD>
		<TD background="templates/guildwars_tree/images/header_logo_02.gif" width="50%">
			<IMG SRC="templates/guildwars_tree/images/header_logo_02.gif" WIDTH=2 HEIGHT=194 ALT=""></TD>
		<TD>
			<IMG SRC="templates/guildwars_tree/images/header_logo_03.gif" WIDTH=300 HEIGHT=194 ALT=""></TD>
		<TD background="templates/guildwars_tree/images/header_logo_04.gif" width="50%">
			<IMG SRC="templates/guildwars_tree/images/header_logo_04.gif" WIDTH=2 HEIGHT=194 ALT=""></TD>
		<TD>
			<IMG SRC="templates/guildwars_tree/images/header_logo_05.gif" WIDTH=193 HEIGHT=194 ALT=""></TD>
	</TR>
</TABLE>
				...
				<table cellspacing="0" cellpadding="2" border="0">
					<tr> 
						...
						&nbsp;*&nbsp;
						<a href="{U_LIST}" class="mainmenu">{L_LIST}</a>
						&nbsp;*&nbsp;
						...
						<a href="/affiliates.php" class="mainmenu">Affiliates</a>
                                                &nbsp;*&nbsp;
                                                <a href="{U_CHAT}" class="mainmenu">{L_CHAT}</a>
						</td>
					
						<td align="center" valign="top" nowrap="nowrap"><span class="mainmenu"><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
