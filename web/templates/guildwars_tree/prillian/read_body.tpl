...
<table border="0" cellpadding="4" cellspacing="1" width="98%" class="forumline">
	...
	<tr>
		<td class="catBottom" colspan="3" height="28" align="center">{S_HIDDEN_FIELDS}
			<input type="submit" name="savereply" value="{L_SAVE_REPLY}" class="button" tabindex="1" onClick="window.resizeTo({REPLY_WIDTH}, {REPLY_HEIGHT})">&nbsp; &nbsp;<input type="submit" tabindex="2" name="nosave" value="{L_REPLY}" class="button" onClick="window.resizeTo({REPLY_WIDTH}, {REPLY_HEIGHT})"><br /><br />
			<input type="button" tabindex="3" value="{L_CLOSE_WINDOW}" class="button" onClick="window.close()" />&nbsp; &nbsp;<input type="submit" tabindex="4" name="saveclose" value="{L_SAVE_CLOSE}" class="button">
		</td>
	</tr>
</table>
</form>
...
<table border="0" cellpadding="3" cellspacing="1" width="98%" class="forumline">
	...
	<tr>
		<td class="catBottom" align="center" height="28">
			{S_QUICK_HIDDEN}<input type="submit" accesskey="s" tabindex="6" name="post" class="button" value="{L_SUBMIT}" />
		</td>
	</tr>
</table>
</form>
