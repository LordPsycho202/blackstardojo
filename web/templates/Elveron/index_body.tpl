...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	<td class="row1" align="center" valign="middle" rowspan="2"><img src="templates/Elveron/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" /></td>
...
<table cellspacing="3" border="0" align="center" cellpadding="0">
  <tr> 
	<td width="20" align="center"><img src="templates/Elveron/images/folder_new_big.gif" alt="{L_NEW_POSTS}"/></td>
	<td><span class="gensmall">{L_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="templates/Elveron/images/folder_big.gif" alt="{L_NO_NEW_POSTS}" /></td>
	<td><span class="gensmall">{L_NO_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="templates/Elveron/images/folder_locked_big.gif" alt="{L_FORUM_LOCKED}" /></td>
