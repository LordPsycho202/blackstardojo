...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  <tr> 
	<th class="thHead" colspan="2" nowrap="nowrap">{L_VIEWING_PROFILE}</th>
  </tr>
  <tr> 
	<td class="catRight" width="40%" align="center"><b><span class="gen">{L_AVATAR}</span></b></td>
...
<!-- BEGIN switch_user_sig_block -->
  ...
  <tr> 
	<td class="catRight" align="center"><b><span class="gen">{L_CONTACT} {USERNAME} </span></b></td>
  </tr>
  <tr> 
...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  ...
  <tr> 
	<td class="row2" align="center" nowrap="nowrap"><span class="cattitle">&nbsp;{medal.L_MEDAL_NAME}&nbsp;</span></td>
	<td class="row2" align="center" nowrap="nowrap"><span class="cattitle">&nbsp;{medal.L_MEDAL_DETAIL}&nbsp;</span></td>
  </tr>
  <!-- BEGIN details -->
  <tr>
