...
<tr>
	<td class="catBottom" align="left" colspan="10" heigt="2{NUM_COLUMNS}"><span class="cattitle"><b>{L_REG_ONLINE}</b></span></td>
</tr>
  <!-- BEGIN reg_user_row -->
  <tr> 
  ...
  <!-- END reg_user_row -->
<tr>
	<td class="catBottom" align="left" colspan="10" heigt="2{NUM_COLUMNS}"><span class="cattitle"><b>{L_GUEST_ONLINE}</b></span></td>
</tr>
