...
<tbody>
	<tr> 
		<td class="row1"><img src="templates/AcidTechBlood/images/post_new.gif" alt="{L_POST}" /><span class="postdetails">{L_POSTED}: {POST_DATE} &nbsp;&nbsp;&nbsp; {L_POST_SUBJECT}: {POST_SUBJECT}</span></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td class="spaceRow"><img src="templates/AcidTechBlood/images/spacer.gif" width="1" height="1" /></td>
	</tr>
</table>
