...
<table border="0" cellpadding="4" cellspacing="1" width="98%" class="forumline">
	...
	<tr>
		<td class="catBottom" colspan="4" height="28" align="center">{S_HIDDEN_FIELDS}
			<input type="submit" tabindex="2" name="nosave" value="{L_REPLY}" class="button" onClick="window.resizeTo({REPLY_WIDTH}, {REPLY_HEIGHT})">&nbsp; &nbsp;
			<input type="button" tabindex="3" value="{L_CLOSE_WINDOW}" class="button" onClick="window.close()" />
		</td>
	</tr>
</table>
</form>
