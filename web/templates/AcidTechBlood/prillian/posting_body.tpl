...
<table border="0" cellpadding="3" cellspacing="1" width="98%" class="forumline">
	...
	<tr>
		...
		<td class="row2">
			...
			<!-- BEGIN switch_find -->
			<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="button" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" />&nbsp;<input type="submit" name="usersubmit" value="{L_BUDDIES}" class="button" onClick="window.open('{U_CONTACT}', '_phpbbcontact', 'HEIGHT=225,resizable=yes,WIDTH=275');return false;" />
			<!-- END switch_find -->
			</span>
		</td>
	</tr>
	...
	<tr>
		<td class="catBottom" colspan="2" align="center" height="28"> {S_HIDDEN_FORM_FIELDS}<input type="submit" accesskey="s" tabindex="6" name="post" class="button" value="{L_SUBMIT}" /> <input type="reset" accesskey="r" tabindex="7" name="post" class="button" value="{L_RESET}" /> <input type="button" tabindex="8" value="{L_CLOSE_WINDOW}" class="button" onClick="window.close()" /></td>
	</tr>
</table>
</form>
