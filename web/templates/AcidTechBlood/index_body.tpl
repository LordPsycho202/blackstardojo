...
<table cellspacing="3" border="0" align="center" cellpadding="0">
  <tr> 
	<td width="20" align="center"><img src="templates/AcidTechBlood/images/folder_new_big.gif" alt="{L_NEW_POSTS}" width="23" height="23" /></td>
	<td><span class="gensmall">{L_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="templates/AcidTechBlood/images/folder_big.gif" alt="{L_NO_NEW_POSTS}" width="23" height="23" /></td>
	<td><span class="gensmall">{L_NO_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="templates/AcidTechBlood/images/folder_locked_big.gif" alt="{L_FORUM_LOCKED}" width="23" height="23" /></td>
