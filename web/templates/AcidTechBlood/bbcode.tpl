...
<tr>
	<td width="19" height="19" class="quote-corner"><img src="templates/AcidTechBlood/images/quote_header.gif" width="19" height="19" alt="" /></td>
	<td width="100%" align="left" class="quote-header">{USERNAME} {L_WROTE}:</td>
</tr>
<tr>
	<td class="quote-left"><img src="templates/AcidTechBlood/images/spacer.gif" width="19" height="45" alt="" /></td>
...
<tr>
	<td width="19" height="19" class="code-corner"><img src="templates/AcidTechBlood/images/code_header.gif" width="19" height="19" alt="" /></td>
	<td width="100%" align="left" class="code-header">{L_CODE}:</td>
</tr>
<tr>
	<td class="code-left"><img src="templates/AcidTechBlood/images/spacer.gif" width="19" height="40" alt="" /></td>
