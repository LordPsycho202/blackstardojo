...
<a href="{switch_trade_in.U_ACTION}" style="text-decoration: none;"><span style="color: ##083808; font-family: Arial, Times New Roman; font-size: 9px;">{switch_trade_in.MESSAGE}</span></a>
</div>
<!-- END switch_trade_in -->
...
<div id="icon_list_layers" style="position:absolute; top:{list_icons.Y_POS}; left:43; width:90; height:15; z-index:2; padding:1px; border: 0px;" valign="middle">
	<span style="color: #FFFF82; font-family: Arial, Times New Roman; font-size: 10px;">3x <img src="images/scratch/icon_{list_icons.ICON_ID}.gif" width="16" height="16" /> = {list_icons.PAYOUT} {L_POINTS_NAME}</span>
</div>
<!-- END list_icons -->
