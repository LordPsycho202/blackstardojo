		  ...
		  <table cellspacing="0" cellpadding="2" border="0">
			...
			<tr> 
			  ...
			  <td align="left"><table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="templates/AcidTechBlood/images/vote_lcap.gif" width="4" alt="" height="12" /></td>
					...
					<td><img src="templates/AcidTechBlood/images/vote_rcap.gif" width="4" alt="" height="12" /></td>
				  </tr>
				</table>
			  </td>
