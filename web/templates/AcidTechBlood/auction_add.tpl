			...
			<table width="400">
				...
				<tr>
				  <td><span class="gen"><b>Title:</b></span></td>
					  <td><input type="text" name="title" maxlength="32" size="20" class="post"><span class="gen"></span></td>
				</tr>
				<tr valign="top">
				  <td><span class="gen"><b>Description:</b></span></td>
				  <td><textarea name="description" rows="3" cols="40" wrap="physical" class="post"></textarea></td>
				</tr>
				<tr>
				  <td><span class="gen"><b>Start Price:</b></span></td>
				  <td><input type="text" class="post" name="startprice" maxlength="6" size="10"><span class="gen"> {L_POINTS_NAME}</span></td>
				</tr>
				<tr>
				  <td><span class="gen"><b>Bid Increment:</b></span></td>
				  <td><input type="text" class="post" name="increment" maxlength="6" size="10"><span class="gen"> {L_POINTS_NAME}</span></td>
				</tr>
				<tr>
				  <td><span class="gen"><b>Buy Price:</b></span></td>
				  <td><input type="text" class="post" name="buyprice" maxlength="6" size="10" value="0"><span class="gen"> {L_POINTS_NAME}</span> <span class="gensmall">(leave as 0 for none)</span></td>
				</tr>
				<tr>
				...
				<tr>
				  <td><br /></td>
				  <td><input type="submit" value="Begin Auction" class="liteoption"><input type="hidden" name="action"  value="addnewauction"> <input type="reset" value="Reset Form" class="liteoption"></td>
				</tr>
			</table>
		</form>
	  </td>
