...
<tbody>
	...
	{POLLBOX} 
	<tr> 
	  <td class="spaceRow" colspan="2"><img src="templates/AcidTechBlood/images/spacer.gif" width="1" height="2" alt="" /></td>
	</tr>
	<tr> 
	  <td class="catBottom" colspan="2" align="center" height="28"> {S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="preview" class="liteoption" value="{L_PREVIEW}" />&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" /></td>
	</tr>
  </tbody>
  </table>
