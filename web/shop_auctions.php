...
//--------------------VARIABLES--------------------------//
$maxauctions = 5; // maximum auctions one user can run at a time
$maxitems = 10; // maximum items per auction
...
The auction has been automatically closed and the items returned to you.';
	...
	$personal = '
		<tr>
		  ...
		  <td class="row1" align="right" width="50%"><span class="gensmall">' . $userdata['user_points'] . ' Yen</span></td>
		</tr>';
